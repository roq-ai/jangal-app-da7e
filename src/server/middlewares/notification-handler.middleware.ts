...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['account-owner'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['account-owner'], key: 'payment_id', tenantPath: [], userPath: [] },
  'feedback_received.create': {
    roles: ['account-owner', 'end-customer'],
    key: 'feedback_id',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['account-owner', 'end-customer'];
