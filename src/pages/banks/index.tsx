...
export function BankListPage(props: BankListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'accounts', header: 'accounts', accessorKey: 'accounts' },
    { id: 'users', header: 'users', accessorKey: 'users' },
    ...
    hasAccess('account', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Account',
          accessorKey: 'account',
          cell: ({ row: { original: record } }: any) => record?._count?.account,
        }
      : null,
