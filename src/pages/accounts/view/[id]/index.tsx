...
import { TransactionHistoryListPage } from 'pages/transaction-histories';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Account Number" text={data?.account_number} />

                <FormListItem label="Account Balance" text={data?.account_balance} />

                <FormListItem label="Account Type" text={data?.account_type} />

                {hasAccess('bank', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Bank"
                    text={
                      <Link as={NextLink} href={`/banks/view/${data?.bank?.id}`}>
                        {data?.bank?.name}
                      </Link>
                    }
                  />
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <TransactionHistoryListPage
                filters={{ reciever_account_number: id }}
                hidePagination={true}
