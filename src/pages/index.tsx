...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Jangal app`}</title>

        <meta
          name="description"
          content="Welcome to Jangal app - your comprehensive banking platform. Perform activities like adding accounts, transferring funds, viewing statements, and much more, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1579621970795-87facc2f976d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYW5raW5nfGVufDB8fHx8MTY5NTg4NzIzM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@micheile?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`micheile henderson`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Jangal app - your comprehensive banking platform. Perform activities like adding accounts, transferring funds, viewing statements, and much more, all in one place.`}
            </Text>
            <Box
